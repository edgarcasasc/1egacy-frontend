...
<style>
	...
	/* Asegúrate de tener definidos los colores primarios o reemplázalos */
	.bg-primary-500 { background-color: #8a6d4a; /* Ejemplo */ }
	.hover\:bg-primary-600:hover { background-color: #715a3c; /* Ejemplo */ }

    /* Añade el resto de clases de utilidad o defínelas aquí si no usas Tailwind/utility-first */
    ...
    .brightness-50 { --tw-brightness: brightness(.5); filter: var(--tw-filter); }
    .p-4 { padding: 1rem; }
    .mx-auto { margin-left: auto; margin-right: auto; }
    .max-w-4xl { max-width: 56rem; }
    .text-4xl { font-size: 2.25rem; line-height: 2.5rem; }
    .md\:text-6xl { @media (min-width: 768px) { font-size: 3.75rem; line-height: 1; } }
    .lg\:text-7xl { @media (min-width: 1024px) { font-size: 4.5rem; line-height: 1; } }
    .font-serif { font-family: serif; /* Ajusta */ }
    .font-bold { font-weight: 700; }
    .mb-4 { margin-bottom: 1rem; }
    .leading-tight { line-height: 1.25; }
    .text-xl { font-size: 1.25rem; line-height: 1.75rem; }
    .md\:text-2xl { @media (min-width: 768px) { font-size: 1.5rem; line-height: 2rem; } }
    .lg\:text-3xl { @media (min-width: 1024px) { font-size: 1.875rem; line-height: 2.25rem; } }
